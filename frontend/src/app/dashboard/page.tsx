...
export default function ReportsDashboard() {
  ...
  return (
    <main className="container animate-fade-in" style={{ padding: "2rem 1.25rem" }}>
          ...
          return (
            <div key={item.id} className="white-card animate-fade-in" style={{ 
              ...
              <div style={{ marginTop: "auto", borderTop: "1px solid #f1f5f9", paddingTop: "1rem", display: "flex", justifyContent: "space-between", alignItems: "center", gap: "1rem" }}>
                ...
                <button 
                  onClick={() => setShowDetailsId(item.id)}
      ...
      {showDetailsId && selectedConsultation && (
        <div style={{ 
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                  <div>
                    ...
                    <input 
                      ...
                      onChange={(e) => setEditData(prev => prev ? { ...prev, chief_complaint: e.target.value } : null)}
                    />
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <textarea 
                      ...
                      onChange={(e) => setEditData(prev => prev ? { ...prev, medications: e.target.value } : null)}
                    />
                  </div>
                </div>
              </div>
